...
│   └── 2026-02-25-10_00_java_迁移可行性评估.md
│
...
1. **🏛️ 系统架构全景** → [系统分析/系统架构全景_2026-02-24.md](系统分析/系统架构全景_2026-02-24.md)
   - 组件职责、数据流、SHM 队列设计、消息格式、Go 包结构、配置体系、启动流程

2. **🏗️ 部署指南** → [核心文档/DEPLOY_GUIDE_2026-02-24.md](核心文档/DEPLOY_GUIDE_2026-02-24.md)
   - 编译、配置、启动、监控、停止

3. **📐 架构设计** → [系统分析/tbsrc-golang_v2_架构更新_2026-02-13-16_00.md](系统分析/tbsrc-golang_v2_架构更新_2026-02-13-16_00.md)
   - C++ → Go 翻译方案、文件对照表、方法对照表

4. **🔧 MWMR 技术规格** → [系统分析/hftbase_MWMR_Go复刻技术规格_2026-02-13-16_00.md](系统分析/hftbase_MWMR_Go复刻技术规格_2026-02-13-16_00.md)
...
**架构文档**:
- [系统架构全景](系统分析/系统架构全景_2026-02-24.md) — **系统架构入口级文档（推荐首读）**
- [tbsrc-golang_v2_架构更新](系统分析/tbsrc-golang_v2_架构更新_2026-02-13-16_00.md) — 架构权威文档（迁移设计）
...
**文档**:
- [Java 迁移可行性评估](java迁移/2026-02-25-10_00_java_迁移可行性评估.md) — C++ → Java 翻译评估、架构方案、风险分析
...
7. **Java 迁移** (`java迁移/`) — Java 迁移评估、设计、实施
8. **归档** (`archive/`) — 已过时的文档

### 文档命名规范

**格式**: `YYYY-MM-DD-HH_mm_模块_摘要.md`（时间在前）
...
**文档组织**: 2026-02-25 更新（新增 Java 迁移目录，文档命名格式改为时间在前）
