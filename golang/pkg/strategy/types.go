...
// TransactionType represents buy/sell direction
// C++: TransactionType in ExecutionStrategyStructs.h
type TransactionType int32

const (
	TransactionTypeBuy  TransactionType = 1 // 买入
	TransactionTypeSell TransactionType = 2 // 卖出
)
...
// TypeOfOrder represents order open/close type for Chinese futures
// C++: TypeOfOrder in ExecutionStrategyStructs.h
type TypeOfOrder int32

const (
	TypeOfOrderAuto           TypeOfOrder = 0 // 自动（由系统决定开平）
	TypeOfOrderOpen           TypeOfOrder = 1 // 开仓
	TypeOfOrderClose          TypeOfOrder = 2 // 平仓
	TypeOfOrderCloseToday     TypeOfOrder = 3 // 平今
	TypeOfOrderCloseYesterday TypeOfOrder = 4 // 平昨
)

// String returns the string representation of TypeOfOrder
func (t TypeOfOrder) String() string {
	switch t {
	case TypeOfOrderAuto:
		return "AUTO"
	case TypeOfOrderOpen:
		return "OPEN"
	case TypeOfOrderClose:
		return "CLOSE"
	case TypeOfOrderCloseToday:
		return "CLOSE_TODAY"
	case TypeOfOrderCloseYesterday:
